...
# ╔═╡ 8855793e-c57f-495c-a73b-3d6c0e9fa10d
...
let
	...
	function match_url(str::String)
	    ...
	    pattern = r"\w?http[s]?:\/\/(www\.)?(.*)?\/?(.)*"
	    return match(pattern, str)
	end
	urls = ["http://www.ufal.com.br",
	        "https://julialang.org/",
	        "any@any.com",
	        "choose any dataset https://odsc.medium.com/20-open-datasets-for-natural-language-processing-538fbfaf8e38",
	        "It's colab https://colab.research.google.com/drive/1x9jwYz3Tfx0AwNqNuQGEjNX-JmPDrtuQ?authuser=2",
	        "It's deepnote https://deepnote.com/workspace/julia-3443-853595ad-42a4-4b95-aa73-052fb36d5972/project/Questoes-Impar-c9862989-b7a0-4a8c-ac67-9c0eea39ecda/notebook/notebook-aabd0ce01a5f4b009faa05e429862e2a"
	    ]
	for str ∈ urls
	    m = match_url(str)
	    if m != nothing
...
begin
	...
	function match_url(str::String)
	    ...
	    m = match(pattern, str)
		str = m[:dd]*"/"*m[:mm]*"/"*SubString(m[:yyyy], 3:4)
	...
	for str ∈ urls
	    println("$(match_url(str))")
	end
end

# ╔═╡ 72c068e8-5894-496e-a5ba-6d9ae05ec3f9
begin
	str = "10/01/2012"
	pattern = r"(?<dd>\d+)/(?<mm>\d+)/(?<yyyy>\d+)"
	m = match(pattern, str)
...
julia_version = "1.8.0"
manifest_format = "2.0"
project_hash = "5f9697f897a61481e0afe253dbab2a904de9c6cf"
